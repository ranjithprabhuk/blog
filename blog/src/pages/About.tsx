    ...
    return (
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        <div className="animate-pulse">
          <div className="w-24 h-24 bg-gray-200 dark:bg-gray-800 rounded-full mx-auto mb-6" />
        ...
        <div className="text-center mb-12">
          {author?.avatar && (
            <img
              ...
              alt={author.name}
              className="w-24 h-24 rounded-full mx-auto mb-6 object-cover border-2 border-gray-200 dark:border-gray-700"
            />
          )}
