    ...
    return (
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        <div className="animate-pulse">
          <div className="w-28 h-28 bg-gray-200 dark:bg-gray-800 rounded-full mx-auto mb-6" />
          <div className="h-8 bg-gray-200 dark:bg-gray-800 rounded w-48 mx-auto mb-4" />
          ...
          <div className="flex justify-center gap-3">
            {author.social.github && (
              <a
                ...
                className="flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-gray-300 dark:hover:border-gray-600 hover:shadow-sm transition-all"
              >
